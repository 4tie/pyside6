...
- [x] 1. Phase 1 — Foundation
  - [x] 1.1 Extend `AppSettings` with `AISettings` Pydantic model
  ...
  - [x] 1.2 Write property test: AISettings serialization round-trip
  ...
  - [x] 1.3 Write property test: routing_mode validation rejects invalid values
  ...
  - [x] 1.4 Write property test: AISettings partial JSON loading uses defaults
  ...
  - [x] 1.7 Create `AIState(QObject)` with all signals
  ...
  - [x] 1.8 Create `AIChatDock` placeholder QDockWidget
  ...
  - [x] 1.9 Wire `AIChatDock` into `MainWindow`
  ...
  - [x] 1.10 Add AI section to `SettingsPage`
  ...
  - [x] 1.11 Phase 1 checkpoint — ensure all tests pass
    - Ensure all tests pass, ask the user if questions arise.

- [x] 2. Phase 2 — Providers and Runtime
  - [x] 2.1 Create `provider_base.py` with `AIProvider` ABC and DTOs
  ...
  - [x] 2.3 Write unit tests for `OllamaProvider`
  ...
  - [x] 2.4 Create `OpenRouterProvider`
  ...
  - [x] 2.7 Write property test: ProviderFactory raises ValueError for unknown providers
  ...
  - [x] 2.8 Create `AgentPolicy` dataclass
  ...
  - [x] 2.9 Create `ConversationRuntime` and `AIWorker`
  ...
  - [x] 2.10 Write property test: ConversationRuntime model routing is correct
  ...
  - [x] 2.11 Write property test: history trimming preserves system message
  ...
  - [x] 2.12 Write property test: clear_history leaves only the system message
  ...
  - [x] 2.13 Write unit tests for `AIWorker` signals
  ...
  - [x] 2.14 Wire `ConversationRuntime` into `AIChatDock`
  ...
  - [x] 2.15 Phase 2 checkpoint — ensure all tests pass
    - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Phase 3 — Tools
  - [x] 3.1 Create `ToolRegistry` and `ToolDefinition`
  ...
  - [x] 3.2 Write property test: ToolRegistry registration validates name and callable
  ...
  - [x] 3.3 Create `ToolExecutor` and `ToolResult`
  ...
  - [x] 3.4 Write property test: ToolExecutor returns ToolResult for any input
  ...
  - [x] 3.6 Implement Phase 3 app tools
  ...
  - [x] 3.7 Write unit tests for Phase 3 app tools
  ...
  - [x] 3.9 Write UI test for `ToolCard`
    - Test expand/collapse toggle changes body visibility
    - _Requirements: 9.4_

  - [x] 3.10 Wire tools into `ConversationRuntime`
  ...
  - [x] 3.11 Phase 3 checkpoint — ensure all tests pass
    - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Phase 4 — Context and Journal
  - [x] 4.1 Create `EventJournal` and `EventRecord`
  ...
  - [x] 4.2 Write property test: EventJournal never exceeds capacity
  ...
  - [x] 4.3 Write property test: EventJournal get_recent returns chronological order
  ...
  - [x] 4.8 Write integration tests for EventJournal adapters
  ...
  - [x] 4.9 Wire context providers into `ConversationRuntime`
  ...
  - [x] 4.10 Phase 4 checkpoint — ensure all tests pass
    - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Phase 5 — Backtest and Strategy Tools
  - [x] 5.1 Implement backtest tools
  ...
  - [x] 5.2 Write unit tests for backtest tools
  ...
  - [x] 5.3 Implement strategy tools
  ...
  - [x] 5.4 Write unit tests for strategy tools
  ...
  - [x] 5.5 Write property test: AppSettings file persistence round-trip
  ...
  - [x] 5.6 Write property test: OpenRouter free model filtering
  ...
  - [x] 5.7 Write property test: tool loop terminates at max_tool_steps
  ...
  - [x] 5.8 Write property test: model capability classification is consistent
  ...
  - [x] 5.9 Final checkpoint — ensure all tests pass
    - Ensure all tests pass, ask the user if questions arise.
