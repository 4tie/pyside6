...
from app.ui.widgets.onboarding_wizard import OnboardingWizard
...
class ModernMainWindow(QMainWindow):
    ...
    def __init__(
        ...
        # ── Wire signals ──────────────────────────────────────────────
        # Key signal connections (checked by P2 signal-continuity test):
    ...
    def _on_optimize_requested(self, strategy_name: str) -> None:
        ...
        self.optimize_page.set_strategy(strategy_name)
